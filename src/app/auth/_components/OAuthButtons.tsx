...
interface OAuthButtonsProps {
  /** Renders variant text: "login" (default) or "register" */
  mode?: "login" | "register";
...
/**
 * OAuthButtons — Social login / register buttons.
 *
 * Renders three provider buttons (Google, Apple, GitHub) with an
 * "أو" / "or" divider. UI-only — no click handlers wired.
 */
